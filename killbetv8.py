...
SAVE_FILE = "dati_giornate.pkl"
CASHOUTS_FILE = "cashouts.pkl"
RICARICHE_FILE = "ricariche.pkl"
WINS_FILE = "manual_wins.pkl"
LOSSES_FILE = "manual_losses.pkl"
CHAMP_FILE = "champions.pkl"
STAKE_FILE = "stake.pkl"

def save_all():
    """Salva tutti i dati amministratore su file pickle."""
    try:
        # Data principale
...
def load_all():
    """Carica tutti i dati se esistono i file pickle."""
    try:
